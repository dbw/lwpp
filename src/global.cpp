  ...
  dostream dout;
	...
	*/
    ...
    IMPLEMENT_GLOBAL(LWSpatialQueryFuncs, LWSPATIALQUERYFUNCS_SERVICE);
		...
		IMPLEMENT_GLOBAL(LWNodeDrawFuncs, LWNODEDRAWFUNCS_GLOBAL);

		// Various transient globals
		IMPLEMENT_TRANSIENT_GLOBAL(LWNodeFuncs, LWNODEFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWNodeInputFuncs, LWNODEINPUTFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWNodeOutputFuncs, LWNODEOUTPUTFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWNodeUtilityFuncs, LWNODEUTILITYFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWNodeEditorFuncs, LWNODEEDITORFUNCS_GLOBAL)

		IMPLEMENT_TRANSIENT_GLOBAL(LWSceneInfo, LWSCENEINFO_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWItemInfo, LWITEMINFO_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWObjectInfo, LWOBJECTINFO_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWObjectFuncs, LWOBJECTFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWPanelFuncs, LWPANELFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWRasterFuncs, LWRASTERFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWXPanelFuncs, LWXPANELFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWMessageFuncs, LWMESSAGEFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWComRing, LWCOMRING_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWImageUtil, LWIMAGEUTIL_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWSurfaceFuncs, LWSURFACEFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWInterfaceInfo, LWINTERFACEINFO_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWImageList, LWIMAGELIST_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWInstUpdate, LWINSTUPDATE_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWTextureFuncs, LWTEXTUREFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWVParmFuncs, LWVPARMFUNCS_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWChannelInfo, LWCHANNELINFO_GLOBAL)
		IMPLEMENT_TRANSIENT_GLOBAL(LWEnvelopeFuncs, LWENVELOPEFUNCS_GLOBAL)

		IMPLEMENT_TRANSIENT_GLOBAL(LWItemInstancerFuncs, LWITEMINSTANCERFUNCS_GLOBAL);
	  IMPLEMENT_TRANSIENT_GLOBAL(LWItemInstanceInfo, LWITEMINSTANCEINFO_GLOBAL);
  
		IMPLEMENT_TRANSIENT_GLOBAL(LWLMonFuncs, LWLMONFUNCS_GLOBAL)
    IMPLEMENT_TRANSIENT_GLOBAL(LWTimeInfo, LWTIMEINFO_GLOBAL)
    
		IMPLEMENT_TRANSIENT_GLOBAL(LWFileIOFuncs, LWFILEIOFUNCS_GLOBAL)
		IMPLEMENT_GLOBAL(LWCompInfo, LWCOMPINFO_GLOBAL)

		TransientGlobal<LWMessageFuncs> LWMessage::globPtr;
		TransientGlobal<LWInstUpdate> InstanceUpdate::globPtr;
}
